...
if Start:
    ...
    Kleineletters = click.confirm('Wil je ook gebruik maken van Kleineletters?', default=False)
...
# Mogelijke characters voor het wachtwoord.
...
# worden de bruikbare characters ingeladen in een lijst voor bruikbare characters. Er wordt direct 1 random character
...
def GenereerWachtwoord(num, klein = False, hoofd = False, nummers=False , speciaal=False):
    ...
    Mogelijke_chars = []
    Aantal = 0
    if klein:  # Voegt de toegestaande characters toe aan de lijst met bruikbare characters.
...
# daarom flatten ik de list. Hierna wordt er een random character uit de lijst gehaald en in Wachtwoord geplaatst.
...
# Omdat de eerste 4 characters altijd in de zelfde volgorde geplaatst worden, randomise ik de characters door elkaar.
